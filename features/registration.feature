...
Scenario: I can register a new account
    ...
    When I am filling in the field "Ваш e-mail"
        And I will press checkbox "Agree with terms"
    ...
    When I am filling in the field "Придумайте пароль" (12 symbols)
        And I am filling in the field "Повторите пароль" (12 symbols)
