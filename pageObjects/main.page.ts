...
class MainPage extends BasePage {
    ...
    private get firstAutoPostLocator() {
        return $(
            "(//h2/a[contains(text(),'Авто')]/ancestor::div[contains(@class,'b-main-page-news-2')]//span[contains(@class,'text-i')])[1]",
        );
    }
    ...
    private get currenncyRateLinkLocator() {
        return $(
            "//a[contains(@class,'b-top-navigation-informers__link')]/span[contains(@class,'js-currency-amount')]",
        );
    }
