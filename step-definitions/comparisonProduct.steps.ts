...
Then(
    /The TV page is open. After being added to the comparison, there are already "2 товара в сравнении" on the bar/,
    async () => {
...
Then(
    /I see page "Сравнение товаров", 2 TVs that I chose earlier. The differing characteristics should be highlighted in orange/,
    async () => {
