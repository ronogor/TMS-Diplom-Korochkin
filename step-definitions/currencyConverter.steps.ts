...
Then(
    /I see converter page is open, today's date is displayed, the exchange rate sections for (.*), (.*), (.*)/,
...
Then(
    /I see the value of the field has not changed, the standard "(.*)" is displayed/,
    async (standartValueField: string) => {
