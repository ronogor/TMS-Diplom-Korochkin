...
Then(
    /I see the decoration page. The product with the correct (.*) and price is displayed on the right/,
...
Then(
    /A page has been opened showing 4 payment methods: "Картой онлайн", "Халва онлайн, "При получении", "Minipay"/,
    async () => {
