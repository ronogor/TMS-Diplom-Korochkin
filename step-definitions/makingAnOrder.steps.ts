...
When(/I will select filter "по возрастанию цены"/, async () => {
...
Then(/I see screen "Товар добавлен в корзину"/, async () => {

});

When(/I will close screen "Товар добавлен в корзину"/, async () => {

});

Then(/I see: "В корзине" is displayed instead of the pressed button. /, async () => {

});

Then(/1 is displayed near the trash icon at the top of the page/, async () => {
...
Then(/Its name and price correspond to the price and name from the product page/, async () => {
...
Then(/I see the Checkout page. The product with the correct name and price is displayed on the right/, async () => {

});

When(/I fill in the address fields/, async () => {

});

When(/I fill in the contact information fields/, async () =>{

});

Then(/I can see the entered data/, async () => {
