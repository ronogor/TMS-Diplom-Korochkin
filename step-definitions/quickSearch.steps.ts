...
Then(
    /The desired product is present in the search results, the price is displayed for it, and the "Предложения" button/,
    async () => {
...
Then(
    /The product page is open. The name corresponds to the one you are looking for "(.*)"/,
