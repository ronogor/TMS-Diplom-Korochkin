...
When(/I am filling in the field "Ваш e-mail"/, async() => {

});

When(/I will press checkbox "Agree with terms"/, async() => {
...
When(/I am filling in the field "Придумайте пароль" (12 symbols)/, async() => {

});

When(/I am filling in the field "Повторите пароль" (12 symbols)/, async() => {
