...
Then(/I see page "Запрос в службу поддержки"/, async () => {
...
Then(/The field displays "Anonymous"/, async () => {
...
Then(/I see the field is highlighted in red/, async () => {
...
Then(/The selection is removed/, async () => {
